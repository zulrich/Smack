...
- (void)viewDidLoad
{
    ...
    self.player1Image.image = [UIImage imageWithData:[[TeamData FifaTeams] getImageForTeamName:team1.name]];
    
    Team *team2 = [[TeamData FifaTeams] getTeamAtIndex:[self.selectedGame.team2Index intValue]];
    
    self.player2Image.image = [UIImage imageWithData:[[TeamData FifaTeams] getImageForTeamName:team2.name]];
    ...
    self.player1TeamLabel.text = team1.name;
    self.player2TeamLabel.text = team2.name;
